...
button_equal = Button(root, text="=", padx=100, pady=20, command=button_equal).grid(row=5, column=1, columnspan=2)
button_clear = Button(root, text="Clear", padx=88, pady=20, command=button_clear).grid(row=4, column=1, columnspan=2)
